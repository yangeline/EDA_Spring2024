...
# Matrices ----
#create value 1-20, specify rows & columns
matrix1
...
matrix1[ , 3] #get the 3rd column 
matrix1[c(12, 14)] #get the value???
matrix1[c(12:14)] #creating a slice
matrix1[2:4, 1:3] #get row 2-4, column1-3
...
```{r DataExercise-1a}
hightemp <- c(52, 34, 41, 49, 56, 65, 69, 69, 66, 62)
lowtemp <- c(21,18, 18,29, 46, 57, 58, 58, 51, 42)
df_tendayweather <- data.frame(hightemp, lowtemp)
df_tendayweather
```
...
hightemp_c <- FtoC(df_tendayweather$hightemp)
hightemp_c
lowtemp_c <- FtoC((df_tendayweather$lowtemp))
lowtemp_c

df_tendayweather_c <- data_frame(hightemp_c, lowtemp_c)
df_tendayweather_c
```
