...
f_month <- month(first(wind_data_clean$DATE)) #extract month from the first data **first observation need to be on the first row of the data frame
f_year <- year(first(wind_data_clean$DATE)) #extract year from the first data **first observation need to be on the first row of the data frame
